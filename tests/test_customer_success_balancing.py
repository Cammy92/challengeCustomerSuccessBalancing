...
class TestCustomerSuccessBalancing(unittest.TestCase):
    ...
    def test_scenario_12(self):
        cs_levels = mapEntities([11, 21, 31, 3, 4, 5])
        customer_levels = mapEntities([10, 10, 10, 20, 20, 30, 30, 30, 20, 60])
        unavailable_cs = []
        expected = 0
        result = customerSuccessBalancingDistribution(cs_levels, customer_levels, unavailable_cs)
        assert result == expected
    ...
    def test_scenario_13(self):
        ...
        cs_levels = mapEntities(arraySeq(999, 1))
        customer_levels = buildSizeEntities(10000, 998)
        unavailable_cs = [999]
        expected = 998
        result = customerSuccessBalancingDistribution(cs_levels, customer_levels, unavailable_cs)
        assert result == expected

        if time.time() - test_start_time > test_timeout_in_ms / 1000:
            raise Exception(f"Test took longer than {test_timeout_in_ms}ms!")

    def test_scenario_14(self):
        cs_levels = mapEntities([1, 2, 3, 4, 5, 6])
        customer_levels = mapEntities([10, 10, 10, 20, 20, 30, 30, 30, 20, 60])
        unavailable_cs = []
        expected = 0
        result = customerSuccessBalancingDistribution(cs_levels, customer_levels, unavailable_cs)
    ...
    def test_scenario_15(self):
        cs_levels = mapEntities([100, 2, 3, 6, 4, 5])
        customer_levels = mapEntities([10, 10, 10, 20, 20, 30, 30, 30, 20, 60])
        unavailable_cs = []
        expected = 1
        result = customerSuccessBalancingDistribution(cs_levels, customer_levels, unavailable_cs)
    ...
    def test_scenario_16(self):
        cs_levels = mapEntities([100, 99, 88, 3, 4, 5])
        customer_levels = mapEntities([10, 10, 10, 20, 20, 30, 30, 30, 20, 60])
        unavailable_cs = [1, 3, 2]
        expected = 0
        result = customerSuccessBalancingDistribution(cs_levels, customer_levels, unavailable_cs)
    ...
    def test_scenario_18(self):
        cs_levels = mapEntities([60, 40, 95, 75])
        customer_levels = mapEntities([90, 70, 20, 40, 60, 10])
        unavailable_cs = [2, 4]
        expected = 1
        result = customerSuccessBalancingDistribution(cs_levels, customer_levels, unavailable_cs)
        assert result == expected
