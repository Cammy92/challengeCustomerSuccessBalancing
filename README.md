#RDStation #challengeCustomerSuccessBalancing
...
## Para testar, siga as instruções abaixo:

Tenha instalado o python, o pytest e pycharm em sua máquina, de acordo com seu sistema operacional.

Baixe o projeto e acesse-o dentro do pycharm.

Para rodar os testes, vá no terminal do pycharm e dentro da pasta rode:
```sh
pytest tests/
```
ou 
```sh
python -m unittest test_customer_success_balancing.py
```
...
**Disponível para avaliação e fins de estudo.**
> Criado por Camila Ramos Araújo 26.08.2023
